...
const tasks = {
  urgent: [
    {
      id: 1,
      description: "Request additional crew for foundation work",
      assignee: { name: "Mike", image: "/placeholder.svg", initials: "MS" },
      dueDate: "Today",
      meeting: "Site Inspection",
    },
    {
      id: 2,
      description: "Submit revised foundation design for sectors 3-4",
      assignee: { name: "Sarah", image: "/placeholder.svg", initials: "SE" },
      dueDate: "Tomorrow",
      meeting: "Site Inspection",
    },
  ],
  high: [
    {
      id: 3,
      description: "Update project timeline in management system",
      assignee: { name: "John", image: "/placeholder.svg", initials: "JP" },
      dueDate: "Thu, May 16",
      meeting: "Site Inspection",
    },
    {
      id: 4,
      description: "Confirm expedited material delivery dates",
      assignee: { name: "Lisa", image: "/placeholder.svg", initials: "LK" },
      dueDate: "Tomorrow",
      meeting: "Site Inspection",
    },
  ],
